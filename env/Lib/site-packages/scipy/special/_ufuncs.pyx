...
cdef extern from r"D:\a\scipy\scipy\.mesonpy-b_1pa2r9\build\scipy/special\_ufuncs_defs.h":
...
cdef extern from r"D:\a\scipy\scipy\.mesonpy-b_1pa2r9\build\scipy/special\_ufuncs_defs.h":
    cdef double _func_erfinv "erfinv"(double) nogil
...
ufunc_erfinv_loops[0] = <np.PyUFuncGenericFunction>loop_d_d__As_f_f
...
ufunc_erfinv_ptr[2*0] = <void*>_func_erfinv
ufunc_erfinv_ptr[2*0+1] = <void*>(<char*>"erfinv")
ufunc_erfinv_ptr[2*1] = <void*>_func_erfinv
